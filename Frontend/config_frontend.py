...
# ── LLM Parser ───────────────────────────────────────────────────────────────────────────────────────────────────────
LLM_API_BASE                = "http://localhost:1234/v1"    # Defined by local LLM app
LLM_MODEL_NAME              = "meta-llama-3.1-8b-instruct"  # Chooses the model for the parsing
LLM_TEMPERATURE             = 0.1                           # Low = more deterministic output
LLM_MAX_TOKENS              = 2048                          # Defines max length of parser input
